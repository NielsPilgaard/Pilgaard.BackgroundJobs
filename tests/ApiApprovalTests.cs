...
public class ApiApprovalTests
{
    ...
    public void public_api_should_not_change_unintentionally()
    {
        ...
        var assemblyToTest = dependencies.Select(Assembly.Load)
            .Where(assembly => assembly.GetTypes().Any(type => type.Name == "ApiMarker") &&
                               assembly.GetName().Name!.Contains(nameToFind, StringComparison.InvariantCultureIgnoreCase))
            .Single();
