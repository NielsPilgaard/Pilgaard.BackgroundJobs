...
public class ScheduledJobBackgroundServiceTests : IAsyncLifetime
{
	...
	public ScheduledJobBackgroundServiceTests()
	{
		var services = new ServiceCollection()
			.AddScheduledJobs(typeof(ScheduledJobBackgroundServiceTests));
