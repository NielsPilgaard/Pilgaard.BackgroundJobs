...
public class recurringjobbackgroundservice_should : IAsyncLifetime
{
    ...
    public recurringjobbackgroundservice_should()
    {
        var services = new ServiceCollection()
            .AddRecurringJobs(typeof(recurringjobbackgroundservice_should));
